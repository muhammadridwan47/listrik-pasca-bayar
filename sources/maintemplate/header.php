		...
		<li class="brand">
			<?php 
				if($data['Level'] == "Pelanggan") {
					echo '<a href="index.php?pages=home-pelanggan">PT PLN (Persero)</a>';
				} else if($data['Level'] == "Petugas") {
					echo '<a href="index.php?pages=home-petugas">PT PLN (Persero)</a>';
				} else {
					echo '<a href="index.php?pages=home-admin">PT PLN (Persero)</a>';
				}
			?>			
		</li>
		<?php 
